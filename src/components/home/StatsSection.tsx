      ...
      <div className="container mx-auto px-4 relative z-10">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="text-primary font-semibold text-sm uppercase tracking-wider">Our Achievements</span>
            <h2 className="font-display font-bold text-3xl md:text-4xl lg:text-5xl mt-4 mb-6">
              Numbers That <span className="bg-gradient-to-r from-sky-dark to-navy-medium bg-clip-text text-transparent">Speak</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A legacy of excellence, built one successful project at a time
            </p>
          </div>
        </ScrollReveal>
          ...
          {stats.map((stat, index) => (
            <ScrollReveal key={stat.label} delay={index * 100}>
              <GlassCard className="p-8 text-center group">
                <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br ${stat.color} flex items-center justify-center shadow-glow transition-transform duration-300 group-hover:scale-110`}>
