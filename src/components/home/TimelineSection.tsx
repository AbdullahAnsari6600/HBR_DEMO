      ...
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="text-sky-light font-semibold text-sm uppercase tracking-wider">Our Process</span>
            <h2 className="font-display font-bold text-3xl md:text-4xl lg:text-5xl mt-4 mb-6 text-primary-foreground">
              From Vision to <span className="text-sky-light">Reality</span>
            </h2>
            <p className="text-primary-foreground/70 max-w-2xl mx-auto">
              A streamlined approach that ensures project excellence at every stage
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={200}>
          <div className="text-center mt-12">
            <p className="text-2xl md:text-3xl font-display font-semibold text-primary-foreground/90">
              ...
              Building Tomorrow, Delivering Today
              <span className="text-sky-light">"</span>
            </p>
          </div>
        </ScrollReveal>
