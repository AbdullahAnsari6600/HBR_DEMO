      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8 animate-zoom-in">
            ...
            <span className="text-sm font-medium text-primary">Trusted Partner in Saudi Arabia</span>
          </div>

          {/* Company Name */}
          <h1 className="font-display font-bold text-5xl md:text-6xl lg:text-7xl mb-6 animate-slide-in-left">
            <span className="bg-gradient-to-r from-sky-dark via-primary to-navy-medium bg-clip-text text-transparent">
              HBR-WORLD
            </span>
          </h1>

          {/* Main Title */}
          <h2 className="font-display font-semibold text-2xl md:text-3xl lg:text-4xl text-foreground mb-6 animate-slide-in-right" style={{ animationDelay: '0.1s' }}>
            Trusted Contracting & Manpower Solutions
            <span className="block text-primary">Across Saudi Arabia</span>
          </h2>

          {/* Subtitle */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-zoom-in" style={{ animationDelay: '0.2s' }}>
            Delivering Excellence in Civil, MEP, Fit-Out Works & Professional Manpower Supply.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-zoom-in" style={{ animationDelay: '0.3s' }}>
          ...
          {/* Trust Indicators */}
          <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-muted-foreground animate-zoom-in" style={{ animationDelay: '0.4s' }}>
