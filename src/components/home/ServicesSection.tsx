        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="font-display font-bold text-3xl md:text-4xl lg:text-5xl mt-4 mb-6">
              Comprehensive <span className="bg-gradient-to-r from-sky-dark to-navy-medium bg-clip-text text-transparent">Services</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              From construction to manpower, we provide end-to-end solutions for all your project needs
            </p>
          </div>
        </ScrollReveal>
          ...
          {services.map((service, index) => (
            <ScrollReveal key={service.title} delay={index * 50}>
              <GlassCard className="p-6 h-full group cursor-pointer">
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${service.color} flex items-center justify-center mb-5 transition-all duration-300 group-hover:scale-110 group-hover:shadow-glow`}>
