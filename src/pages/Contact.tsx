...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email Us',
      details: ['info@hbr-world.com', 'support@hbr-world.com'],
      action: 'mailto:info@hbr-world.com',
    },
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['King Fahd Road', 'Riyadh, Saudi Arabia'],
      action: '#map',
    },
    {
      icon: Clock,
            ...
            <ScrollReveal>
              <div className="text-center max-w-3xl mx-auto">
                ...
                <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl mt-4 mb-6">
                  Let's <span className="bg-gradient-to-r from-sky-dark to-navy-medium bg-clip-text text-transparent">Connect</span>
                </h1>
                <p className="text-muted-foreground text-lg">
                  Have a project in mind? Get in touch with us today for a free consultation
                </p>
              </div>
            </ScrollReveal>
          </div>
                    ...
                    <div className="aspect-[4/3] bg-gradient-to-br from-muted to-secondary relative">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-foreground font-display font-semibold">HBR-WORLD Headquarters</p>
                          <p className="text-muted-foreground text-sm mt-1">Riyadh, Saudi Arabia</p>
                        </div>
                      </div>
