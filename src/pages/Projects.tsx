      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-card rounded-3xl max-w-3xl w-full max-h-[90vh] overflow-auto shadow-2xl animate-zoom-in">
            ...
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 w-10 h-10 rounded-full bg-muted hover:bg-muted/80 flex items-center justify-center"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <button
              onClick={() => navigateProject("prev")}
              className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-muted/80 flex items-center justify-center"
            >
              <ChevronLeft className="w-5 h-5" />
            </button>
            ...
            <button
              onClick={() => navigateProject("next")}
              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-muted/80 flex items-center justify-center"
            >
              <ChevronRight className="w-5 h-5" />
            </button>
            ...
            <div className="p-8">
              <span className="text-primary text-sm font-semibold uppercase tracking-wider">
                {t(`projects.categories.${selectedProject.category}`, selectedProject.category)}
              </span>

              <h2 className="font-display font-bold text-2xl md:text-3xl mt-2 mb-4">
                {t(selectedProject.title, selectedProject.title)}
              </h2>
