...
const categories = [
  {
    ...
    workers: [
      ...
      'Painters', 'Tile Setters', 'Steel Fixers', 'Scaffolders'
    ],
  },
  {
    id: 'semi-skilled',
    ...
    workers: [
      'Helper Electricians', 'Helper Plumbers', 'Assistant Masons',
      'Junior Carpenters', 'Finishing Workers', 'Installation Helpers'
    ],
  },
  {
    id: 'general',
    ...
    workers: [
      'Construction Laborers', 'Loading Workers', 'Cleaning Staff',
      'Material Handlers', 'Site Helpers', 'General Assistants'
    ],
  },
  {
    id: 'engineers',
    ...
    workers: [
      ...
      'HVAC Engineers', 'Site Engineers', 'Project Engineers'
    ],
  },
  {
    id: 'technicians',
    ...
    workers: [
      'HVAC Technicians', 'Electrical Technicians', 'AC Technicians',
      'Elevator Technicians', 'Fire Alarm Technicians', 'BMS Technicians'
    ],
  },
  {
    id: 'drivers',
    ...
    workers: [
      'Heavy Vehicle Drivers', 'Light Vehicle Drivers', 'Forklift Operators',
      'Crane Operators', 'Dump Truck Drivers', 'Bus Drivers'
    ],
  },
  {
    id: 'welders',
    ...
    workers: [
      'TIG Welders', 'MIG Welders', 'Arc Welders',
      'Pipe Welders', 'Structural Welders', 'Aluminum Welders'
    ],
  },
  {
    id: 'operators',
    ...
    workers: [
      'Excavator Operators', 'Loader Operators', 'Crane Operators',
      'Bulldozer Operators', 'Grader Operators', 'Concrete Pump Operators'
    ],
  },
  {
    id: 'safety',
    ...
    workers: [
      'HSE Officers', 'Safety Supervisors', 'Fire Safety Officers',
      'First Aid Officers', 'Environmental Officers', 'Safety Trainers'
    ],
  },
  {
    ...
    workers: [
      'Pipe Fitter Helpers', 'HVAC Helpers', 'Equipment Helpers',
      'Maintenance Helpers', 'Installation Assistants'
    ],
  },
  {
    ...
    workers: [
      'Cable Pullers', 'Electrical Assistants', 'Panel Helpers',
      'Lighting Helpers', 'Conduit Helpers'
    ],
  },
  {
    ...
    workers: [
      'Concrete Workers', 'Block Layers', 'Steel Workers',
      'Demolition Workers', 'Formwork Laborers', 'Plastering Workers'
    ],
  },
];
          ...
          <div className="container mx-auto px-4 relative z-10">
            <ScrollReveal>
              <div className="text-center max-w-3xl mx-auto">
                <span className="text-primary font-semibold text-sm uppercase tracking-wider">Manpower Supply</span>
                <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl mt-4 mb-6">
                  Professional <span className="bg-gradient-to-r from-sky-dark to-navy-medium bg-clip-text text-transparent">Workforce</span>
                </h1>
                <p className="text-muted-foreground text-lg">
                  Skilled, semi-skilled, and general workforce solutions tailored to your project requirements
                </p>
              </div>
            </ScrollReveal>
          </div>
